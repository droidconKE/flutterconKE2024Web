...
export default function SpeakersPage({
  ...
  return (
    <div className="w-full mt-10 lg:mt-20 xl:mt-10 mb-0">
      ...
      <section className="bg-[url('/images/element_left.png'),url('/images/svg/login-dark.svg')] bg-no-repeat bg-[position:bottom_100.17%_right_110%,bottom_100.2%_left_100%] md:bg-[position:bottom_102.2%_right_109%,bottom_100%_left_103%] bg-[length:100px,_110px] md:bg-[length:350px,_450px]">
