...
// would be rendered as given, so only a plain web link is kept. Pasted values
// often carry surrounding whitespace, so it is trimmed rather than treated as
// a reason to drop the link.
