...
const highlights = [
  {
    ...
    body: 'Hands-on labs, engineering leader panels, and real dev talk. Master Agentic AI, level up your security game, and fast-track your career at the DroidconKE joint track.',
