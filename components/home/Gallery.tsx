...
export const Gallery = () => {
  ...
  return (
    <section className="s-container w-full h-auto bg-white dark:bg-black-dark py-10 md:py-20 transition-colors">
      {/* Header Block */}
      <div className="w-full bg-accent dark:bg-accent-dark rounded-[20px] p-8 mb-12 md:mb-16">
        ...
        <h2 className="text-white dark:text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[72px] leading-tight font-display whitespace-nowrap">
          Past fluttercon events
        </h2>
      </div>
