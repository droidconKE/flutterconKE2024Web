...
- **Display: Rauschen B** — sans-serif grotesque by Philipp Herrmann / Out of the Dark (2021). Commercial/licensed (not on Google Fonts); self-hosted via `next/font/local`. Same font as droidconKE.
